...
export const Product = ({ onProductLike, pictures, likes=[], reviews=[], tags, name,price,discount,description, weight, _id, setProduct}) => {
  ...
  <>
    <ContentHeader title={name}>
      <div>
        ...
        <span>{reviews.length || "Нет"} отзывов</span>
      </div>      
    </ContentHeader>
